...
- [`df8e23a`](https://github.com/msmps/opentui-ui/commit/df8e23a5c9f60b01ef8596fd8d7bd8d3a080aa67) Thanks [@msmps](https://github.com/msmps)! - feat(toast): add mouse hover functionality to pause and resume toast
  feat(toast): add @opentui/solid support

## 0.0.2

### Patch Changes

- 620ec9d: updated documentation
